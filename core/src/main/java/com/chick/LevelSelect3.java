...
public class LevelSelect3 implements Screen {
    private Stage stage;
    private chick game;
    ...
    public LevelSelect3(chick game) {
        this.game = game;
        ...
        // Load textures
        l1 = new Texture(Gdx.files.internal("tarnished.png"));
...
//                game.setScreen(new Gameplay4(game)); // Switch to Gameplay screen
                game.setScreen(new Loading(game, new Gameplay4(game)));
                game.getBackgroundMusic().pause();
                game.geteldenring().play();
            }
        });
