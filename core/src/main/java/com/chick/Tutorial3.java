...
public class Tutorial3 implements Screen {
    private Stage stage;
    private chick game;
    ...
    public Tutorial3 (chick game) {
        ...
        blur = new Texture(Gdx.files.internal("tut1/5.png"));

        back = new Texture(Gdx.files.internal("tut1/6.png"));
        ...
        back_button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                clickSound.play();
                game.setScreen(new Gameplay(game));  // Pass the next screen
            }
        });
