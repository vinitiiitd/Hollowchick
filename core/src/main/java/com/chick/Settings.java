...
public class Settings implements Screen {
    ...
    public Settings(chick game) {
        ...
        blur = new Texture(Gdx.files.internal("Settings/blur.png"));
        ...
        ImageButton cre_b = new ImageButton(new TextureRegionDrawable(crd));

        back_button.setPosition(510, 275);
        back_button.setSize(40, 120);
        cre_b.setPosition(225, 150);
        cre_b.setSize(200, 50);

        // Set positions and sizes for buttons
        on_Button.setPosition(333, 75);
        on_Button.setSize(200, 300);
        on1_Button.setPosition(108, 75);
        on1_Button.setSize(200, 300);

        off_Button.setPosition(333, 75);
        off_Button.setSize(200, 300);


        off1_Button.setPosition(108, 75);
        off1_Button.setSize(200, 300);
        // Hide off button initially
...
//                }
        ...
        cre_b.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                if(check.getcheck()){
                    game.getclickSound().play();
        ...
        stage.addActor(cre_b);

        // Set the stage as the input processor
        Gdx.input.setInputProcessor(stage);
        addHoverEffect1(off_Button, 200, 300);
        addHoverEffect1(off1_Button, 200, 300);
        addHoverEffect1(on_Button, 200, 300);
        addHoverEffect1(on1_Button, 200, 300);
        addHoverEffect1(back_button, 40, 120);
        addHoverEffect1(cre_b,200, 50);
    }
